...
excerpt: >
      <p style="margin-bottom:0.25em; border-radius: $border-radius; padding: 0.5em 1em; font-weight: bold; text-align:left; font-family:$pridi; font-size: 200%; cursor: not-allowed; margin-inline-start: 25%; padding: 0.1em .25em; background-color: #fff;">METRO DC</p>
